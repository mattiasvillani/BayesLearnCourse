...
> This is a course on the [Master's Program in Statistics](https://utbildning.su.se/english/education/course-catalogue/ss/sstao) and the [Master’s Program in Data Science, Statistics and Decision Analysis](https://dsv.su.se/sdsbo) at Stockholm University.
...
The course consists of [lectures](lectures.qmd), [mathematical exercises](exercises.qmd) and computer labs where you work on a [two-part home assignment](homeassignment.qmd).
...
The course schedule can be found on [TimeEdit](https://cloud.timeedit.net/su/web/stud1/s.html?sid=3&object=cevt_39064_HT2026&startDate=20260801&endDate=20270206&type=courseevent&h=t&l=en). A tip is to select *Subscribe* in the upper right corner of TimeEdit and then paste the link into your phone's calendar program.

### Formula sheet

This [formula sheet](/misc/BLformulaSheet.pdf) will be available as a pdf via the computer in the exam room.
...
![](/misc/yulia.jpeg){width="30%"}\
[Yulia Ryanova](https://www.su.se/english/profiles/akma0227-1.800159)<br>Exercises <br> PhD student in Statistics

![](/misc/akram.jpeg){width="37%"}\
[Akram Mahmoudi](https://www.su.se/english/profiles/akma0227-1.800159)<br>Computer labs <br> PhD in Statistics and Lecturer
