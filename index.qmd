...
The course consists of [lectures](lectures.qmd), [mathematical exercises](exercises.qmd) and [computer labs](computerlabs.qmd) where you work on a two-part home assignments.
...
The course schedule can be found on [TimeEdit](https://cloud.timeedit.net/su/web/stud1/s.html?i=x7ce6e5Z4n0wknyaQhxnZclQln_0nbZH05QcTcn_sl7916Qy6d650606u67310905ZWQnw). A tip is to select *Subscribe* in the upper right corner of TimeEdit and then paste the link into your phone's calendar program.

### Formula sheet

This [formula sheet](/misc/BLformulaSheetv0_1.pdf) will be available as a pdf via the computer in the exam room.
...
[Valentin Zulj](https://valentinzulj.github.io/)<br>Computer labs <br> PhD student in Statistics and Teaching assistant
:::
